...
rawD = readMat("/Users/kenjilee/Downloads/seuratAnalysis 2/theta_modulation_index.mat")
thetaMod = rawD$test

featureData = readMat("/Users/kenjilee/Downloads/seuratAnalysis 2/features_cellExp_new_Jun2023.mat")
features = featureData$features
nData = dim(features)

selectedData =sample(1 : nData[1], size = 320, replace = F)
...
selectedData = fullAllenData[sample(1:aD[1], size=165, replace=F)]
...
WFce = readMat("/Users/kenjilee/Downloads/seuratAnalysis 2/finalWaveforms.mat");
...
load('/Users/kenjilee/Downloads/seuratAnalysis 2/isi_cellExp.Rda')
X_ISI = t(isi)
